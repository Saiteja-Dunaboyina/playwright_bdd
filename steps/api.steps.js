...
Then('I can able to Update a current booking', async () => {
  ...
  console.log("the put data is", UpdateData.data);
...
Then('I am able to Update a current booking with a partial payload', async () => {
...
Then('I can delete a particular user', async () => {
